...
document.addEventListener('DOMContentLoaded', () => {
    ...
    loadData();
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('totalDevices').textContent = '3';
            document.getElementById('registeredDevices').textContent = '1';
            document.getElementById('reachedDevices').textContent = '1';
            document.getElementById('deliveredDevices').textContent = '1';
        });